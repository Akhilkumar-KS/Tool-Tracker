...
echo '<input type="text" name="toolname" id="toolname'.$toolkitid.'" class="form-control" placeholder="Enter Tool Name"';
echo 'autocomplete="no-fill" required>';
echo '</div>';
echo '<div class="form-group">';
echo '<input type="text" name="num" id="num'.$toolkitid.'" class="form-control"';
echo 'placeholder="Enter Count" autocomplete="no-fill" required>';
echo '</div>';
echo '<div class="form-group">';
echo '<input type="button" onClick="addtool('.$toolkitid.')" on value="Add Tool" class="btn btn-dark btn-block">';
echo '</div>';
echo '</form>';
echo '</div>';
